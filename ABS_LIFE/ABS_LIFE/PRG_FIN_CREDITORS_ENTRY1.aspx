<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="PRG_FIN_CREDITORS_ENTRY1.aspx.vb" Inherits="ABS_LIFE.PRG_FIN_CREDITORS_ENTRY1" %>
...
<body onload="<%=publicMsgs%>" onclick="return cancelEvent('onbeforeunload')">
            ...
            <div class="rounded">
                <div class="top-outer">
                    <div class="top-inner">
                        <div class="top">
                            <h2>
                                <asp:Label ID="lblDesc" runat="server" Text="Invoice Entry"> </asp:Label></h2>
                        </div>
                    </div>
                </div>
                <div class="mid-outer">
                    <div class="mid-inner">
                        <div class="mid">
                            <table class="tbl_menu_new">
                                <tr>
                                    <td colspan="4" class="myMenu_Title" align="center">
                                        <asp:Label ID="lblDesc1" runat="server" Text="Invoice Entry"></asp:Label>
                                    </td>
                                    <td>
                                    </td>
                                    <td>
                            ...
                            Width="150px" Enabled="False" AutoPostBack="True"></asp:TextBox> 
                                    </td>
                                    <td class="style1">
                                        Entry Date
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtBatchNo" runat="server" Width="270px">0</asp:TextBox>
                                    </td>
                                    <td>
                                        Batch Date
                                    </td>
                                    <td>
                                        <asp:TextBox ID="txtBatchDate" runat="server" Width="150px">0</asp:TextBox>(yyyymm)
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="cmbTransType" runat="server" Width="270px">
                            ...
                            <div id="DetailPart">
                                <table class="tbl_menu_new">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:Label ID="lblRef4" runat="server" Text="Creditor Code"></asp:Label>
                                        </td>
                                        <td>
                                                                                        Item</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtReceiptRefNo1" runat="server" Width="90px"></asp:TextBox><img src="img/glass1.png" id="CreditorCodeSearch" alt="search" class="searchImage" /><img src="img/plusimage.png" id="CreditorAdd" alt="add record" class="searchImage" /></td>
                                        <td>
                            ...
                            <asp:TextBox ID="txtPrice" runat="server" Width="80px" AutoPostBack="True"></asp:TextBox>
                                        ...
                                        <td>
                                            <asp:TextBox ID="txtQty" runat="server" Width="96px" 
    ...
    <ItemStyle CssClass="first"></ItemStyle>
             ...
             DataNavigateUrlFormatString="~/PRG_FIN_CREDITORS_ENTRY1.aspx?idd={0},{1},{2},{3},{4}" HeaderText="Coy"  Visible="false" 
             HeaderStyle-CssClass="first" ItemStyle-CssClass="first"  >
    ...
    <ItemStyle CssClass="first"></ItemStyle>
             ...
             DataNavigateUrlFormatString="~/PRG_FIN_CREDITORS_ENTRY1.aspx?idd={0},{1},{2},{3},{4}" HeaderText="Proc Dt"  
             HeaderStyle-CssClass="first" ItemStyle-CssClass="first"  >
    ...
    <ItemStyle CssClass="first"></ItemStyle>
             ...
             DataNavigateUrlFormatString="~/PRG_FIN_CREDITORS_ENTRY1.aspx?idd={0},{1},{2},{3},{4},{5}" HeaderText="SSN"  
             HeaderStyle-CssClass="first" ItemStyle-CssClass="first"  >
