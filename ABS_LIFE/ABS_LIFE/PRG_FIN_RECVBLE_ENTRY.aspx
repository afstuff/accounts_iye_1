			    ...
			    <table class="tbl_menu_new">
			        <tr><td colspan="9" class="myMenu_Title" align="center">Transaction Detail Entry</td><td></td><td></td><td></td></tr>
			         ...
			         <tr>
					    ...
					    <td colspan=5><asp:Label ID="lblRefDate" Text="Ref. Date" runat="server" Visible=false></asp:Label>        
					    <asp:TextBox ID="txtRefDate" runat="server" Width="100px" BorderStyle="None" Visible=false
                            Font-Bold="true"></asp:TextBox><asp:Label ID="lblRefAmt" Text="Ref. Amt" runat="server" Visible=false></asp:Label>
                            <asp:TextBox ID="txtRefAmt" runat="server" BorderStyle="None" Width="150px" Text="0.00" Visible=false
                                Font-Bold="true"></asp:TextBox> <asp:Label ID="lblRemarks"  runat="server"  Text="Description"></asp:Label>
<asp:TextBox ID="txtRemarks" runat="server" Width="300px" tabindex=16></asp:TextBox>                                
                                </td><td></td>                         <td><asp:Button ID="butSaveDetail" runat="server" Text="Save" onclick="butSave_Click" />
    ...
    <table>
        <tr><td>Receipt Number</td>
			<td ><asp:TextBox ID="txtRecptNo" runat="server" Width="100px"></asp:TextBox></td></tr>
			        <tr><td></td><td><asp:Button ID="butPrintRecpt" runat="server" Text="Print" Visible="True" /></td></tr>
    </table>
