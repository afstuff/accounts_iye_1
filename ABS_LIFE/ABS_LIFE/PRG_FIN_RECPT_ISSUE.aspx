     ...
     <div class="grid">
			...
			<table class="tbl_menu_new">
				...
				<tr>
					...
					<asp:TextBox ID="txtProductCode" runat="server" Width="150px" CssClass="popupOffset" BorderStyle="None"></asp:TextBox>
			...
			<table class="tbl_menu_new">
				    <tr><td><asp:Label ID="lblMainDescDisp" runat="server" text="Main A/C DR"></asp:Label></td><td><asp:Label ID="Label1" runat="server" text="Sub A/C DR"></asp:Label></td><td><asp:Label ID="Label2" runat="server" text="Assured Name"></asp:Label></td></tr>
				    <tr><td><asp:TextBox ID="txtMainAcctDebitDesc" runat="server" Width="300px" BorderStyle="None" Enabled="false" > </asp:TextBox></td><td><asp:TextBox ID="txtSubAcctDebitDesc" runat="server" Width="300px" BorderStyle="None" Enabled="false" ></asp:TextBox></td><td><asp:TextBox ID="txtAssuredName" runat="server" Width="270px" Enabled="false" BorderStyle="None"></asp:TextBox></td></tr>
				    <tr><td><asp:Label ID="Label3" runat="server" text="Main A/C CR"></asp:Label></td><td><asp:Label ID="Label4" runat="server" text="Sub A/C CR"></asp:Label></td><td><asp:Label ID="Label5" runat="server" text="Agent's Name"></asp:Label></td></tr>
				    <tr><td><asp:TextBox ID="txtMainAcctCreditDesc" runat="server" Width="300px" BorderStyle="None" Enabled="false"></asp:TextBox></td><td><asp:TextBox ID="txtSubAcctCreditDesc" runat="server" Width="300px" BorderStyle="None" Enabled="false"> </asp:TextBox></td><td><asp:TextBox ID="txtAgentName" runat="server" Width="270px" Enabled="false" BorderStyle="None" ></asp:TextBox></td></tr>
		    </table>
